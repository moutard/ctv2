...
Cotton.UI.Topbar.Search = Class.extend({
  ...
  _search : function(sQuery) {
    ...
    // TODO: The fact that we need to call both push_state and search stories is really weird.
    // We sould just call the new location and the router would do the job.
    // Because it means when I reload the page woody.html?q=css then it will not work.
