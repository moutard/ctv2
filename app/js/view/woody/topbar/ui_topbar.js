...
Cotton.UI.Topbar.UITopbar = Class.extend({
  ...
  /**
   * bar with settings button, favorites button etc...
   */
  _oMoreOptionsBar : null,
  ...
  init : function(oGlobalDispatcher) {
    ...
    this._$topbar.append(
        this._$topbar_container.append(this._$logo, this._oMenu.$(), this._oSearch.$(), this._$hamburger_menu),
