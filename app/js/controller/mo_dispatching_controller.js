  ...
  init : function(oMoController, oGlobalDispatcher) {
    ...
    */
    ...
    oGlobalDispatcher.subscribe('search_stories', this, function(dArguments){
      oMoController._oFinder.search(dArguments['search_words'], function(lStories, sSearchPattern){
        var sSearchTitle = "search results for " + sSearchPattern.toUpperCase();
        oMoController._oWorld.openPageSearchResults(lStories, sSearchTitle, "No Result");
      });
    });
    ...
    oGlobalDispatcher.subscribe('autocomplete_ask', this, function(dArguments){
      oMoController._oFinder.autocomplete(dArguments['prefix'],
